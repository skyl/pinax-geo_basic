...
class GeoTranslationManager(models.GeoManager):
    pass
...
class Area(models.Model):
    ...
    background = models.CharField(max_length=7, help_text="e.g. #FFAE00",
    ...
    def render_tag_list(self):
        ...
        context = { 'tags':
                Tag.objects.cloud_for_model(Attraction, filters={'point__within': self.poly}, counts_all=True)[:10],
                'area': self,
        }
...
class Attraction(models.Model):
    ...
    def get_cloud(self):
        ...
        return Tag.objects.cloud_for_model(Attraction,
                filters={'slug':self.slug}, counts_all=True)

    def render_tag_list(self):
        '''Produce the html for the popup'''
        context = { 'tags':
                Tag.objects.cloud_for_model(Attraction, filters={'slug': self.slug}, counts_all=True)[:10]
        }
        return render_node(tag_cloud_small_template, context)
